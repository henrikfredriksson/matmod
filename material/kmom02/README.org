...
Ni ska skapa en sida i valfritt programmeringsspråk där följande ska ingå.
...
detta slumpförsök många gånger så kommer summan av tärningarna vara
normalfördelad.

Uppgiften går ut på att ni ska visualisera central gränsvärdessatsen.

** Uppgifter

Ni ska skapa en sida i valfritt programmeringsspråk där följande ska ingå.

1. Välj en slumpmodell med oberoende slumpvariabler
2. Genomför ett stort antal försök av slumpmodellen och spara utfallen.
3. Plotta ett [[https://sv.wikipedia.org/wiki/Histogram][histogram]] av
   försökens utfall.
